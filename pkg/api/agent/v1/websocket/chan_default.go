...
// GetEndOfThoughtResponse returns the end of thought response channels
func (dch DefaultChanHandler) GetEndOfThought() []*chan *interfaces.EndOfThoughtResponse {
	return []*chan *interfaces.EndOfThoughtResponse{&dch.endOfThoughtResponse}
}
