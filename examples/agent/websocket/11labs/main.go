...
func main() {
	...
	tOptions.Agent.Speak.Provider.Type = "eleven_labs"
	tOptions.Agent.Speak.Provider.Model = ""
	tOptions.Agent.Speak.Provider.ModelId = "eleven_multilingual_v1"
	tOptions.Agent.Speak.Endpoint = new(interfacesv1.Endpoint)
	tOptions.Agent.Speak.Endpoint.Headers = map[string]string{
		"xi-api-key": "",
	}
	tOptions.Agent.Speak.Endpoint.Url = "https://api.elevenlabs.io/v1/text-to-speech/pNInz6obpgDQGcFmaJgB/stream"
